...
在编写任务文档(task.md)的时候, 需要遵循规格文档(spec.md), 如果规格文档中有模糊不清或
前后矛盾的地方, 那么agent就必须自己做出合理假设来解决并记录问题.

**注意:**
  - 做任务规划时违反规格文档所引起的问题不是规格文档问题, 必须马上解决, 禁止记录下来不处理
...
在编写代码和测试的时候, 需要遵循任务文档(task.md)中的任务描述, 如果任务描述中有错漏或前后矛
盾的地方, 那么agent就必须自己做出合理假设来解决并记录问题.

**注意:**
  - 实现者违反任务描述所引起的问题不是任务规划问题, 必须马上解决, 禁止记录下来不处理
  - 做任务规划和编写任务文档时发现的任务规划问题, 必须马上解决, 禁止记录下来不处理
