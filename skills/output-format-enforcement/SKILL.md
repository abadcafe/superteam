...
2. **Exact status values** — Continue/Done, PASS/FAIL, Pending/Resolved/Don't Fix. Synonyms = failure.
...
| Using synonym for status | Natural language | Use exact: Continue/Done, PASS/FAIL |
